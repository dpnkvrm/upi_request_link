...
!function(t, e) {
    ...
    function t(t, e) {
        var n;
        return "function" == typeof Object.create ? n = Object.create(t) : (s.prototype = t,
        n = new s,
        s.prototype = null),
        e && i(!0, n, e),
        n
    ...
    function e(e, n, s, r) {
        var o = this;
        return "string" != typeof e && (r = s,
        s = n,
        n = e,
        e = null),
        "function" != typeof n && (r = s,
        s = n,
        n = function() {
    ...
    var h = n
      ...
      , c = f.extend({
        draw: function(t) {
            ...
            for (o.fillStyle = n.foreground,
            o.globalAlpha = n.foregroundAlpha,
            e = 0; e < t.width; e++)
                for (i = 0; i < t.width; i++)
      ...
      , v = h.extend(function(t) {
        ...
        _appendEccToData: function() {
            ...
            for (t = 0; t < this._neccBlock1; t++)
                this._appendData(e, i, n, s),
                e += i,
                n += s;
            for (t = 0; t < this._neccBlock2; t++)
                this._appendData(e, i + 1, n, s),
                e += i + 1,
                n += s
        },
        _applyMask: function(t) {
            ...
            case 5:
                ...
                i++)
                    ...
                    e++)
                        3 === e && (e = 0),
                        (n & s & 1) + !(!e | !i) || this._isMasked(n, s) || (r[n + s * o] ^= 1);
                break;
            case 6:
                for (i = 0,
                s = 0; s < o; s++,
        ...
        _checkBadness: function() {
            ...
            for (s = 0; s < h - 1; s++)
                for (n = 0; n < h - 1; n++)
                    (a[n + h * s] && a[n + 1 + h * s] && a[n + h * (s + 1)] && a[n + 1 + h * (s + 1)] || !(a[n + h * s] || a[n + 1 + h * s] || a[n + h * (s + 1)] || a[n + 1 + h * (s + 1)])) && (r += v.N2);
            var f = 0;
            for (s = 0; s < h; s++) {
                for (i = 0,
                o[0] = 0,
        ...
        _getBadness: function(t) {
            ...
            for (e = 0; e <= t; e++)
                n[e] >= 5 && (i += v.N1 + n[e] - 5);
            for (e = 3; e < t - 1; e += 2)
                n[e - 2] === n[e + 2] && n[e + 2] === n[e - 1] && n[e - 1] === n[e + 1] && 3 * n[e - 1] === n[e] && (0 === n[e - 3] || e + 3 > t || 3 * n[e - 3] >= 4 * n[e] || 3 * n[e + 3] >= 4 * n[e]) && (i += v.N3);
            return i
        },
        _finish: function() {
        ...
        _insertAlignments: function() {
            ...
            if (n > 1)
                for (t = u.BLOCK[n],
                i = s - 7; ; ) {
                    for (e = s - 7; e > t - 3 && (this._addAlignment(e, i),
                    !(e < t)); )
                        e -= t;
                    if (i <= t + 9)
                        break;
        ...
        _insertTimingRowAndColumn: function() {
            ...
            for (t = 0; t < i - 14; t++)
                ...
                this._setMask(6, 8 + t)) : (e[8 + t + 6 * i] = 1,
                e[6 + i * (8 + t)] = 1)
        },
        _insertVersion: function() {
            ...
            if (r > 6)
                ...
                i = 0; i < 6; i++)
                    for (n = 0; n < 3; n++,
                    e--)
                        1 & (e > 11 ? r >> e - 12 : t >> e) ? (s[5 - i + o * (2 - n + o - 11)] = 1,
                        s[2 - n + o - 11 + o * (5 - i)] = 1) : (this._setMask(5 - i, 2 - n + o - 11),
      ...
      , w = h.extend(function(t) {
        ...
        init: function(t, e, i) {
            ...
            for (n in this.options)
                k.hasOwn(this.options, n) && (s = this.options[n],
        ...
        _setAll: function(t, e, i) {
            ...
            var n, s = !1;
            for (n in t)
                k.hasOwn(t, n) && this._set(n, t[n], e, i) && (s = !0);
            return s
        }
    }, {
